...
export const features = [
  ...
  },
  {
    ...
    intro:
      "Lead Tracking shows a lead moving through your funnel automatically. Lead Management goes further - filter by status or date, search across everything captured, and export to CSV whenever you need the raw data outside Commission. Free for every business.",
    points: [
      ...
      { title: "No plan required", body: "Every business gets full Lead Management - it is not a paid add-on." },
    ],
  },
  {
    slug: "custom-fields",
    ...
    points: [
      ...
      { title: "Up to 5 questions per campaign", body: "Free for every business - no plan required." },
    ],
  },
];
