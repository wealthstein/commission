...
export const integrations = [
  {
    ...
    points: [
      { title: "Native, not bolted on", body: "The Interest Form to WhatsApp handoff is a built-in step of every qualified-lead campaign, not a separate integration to configure." },
