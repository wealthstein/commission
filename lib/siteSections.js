...
export const integrations = [
  {
    ...
    intro:
      "Available on Medium and Large plans. Add one script tag to your own site, then call a single function from your form's submit handler - leads are created directly in Commission, with no customer redirect at all.",
    points: [
      ...
      { title: "A real tradeoff worth knowing", body: "Leads captured this way skip Radar's inline verification step, since that step depends on Commission's own hosted page." },
    ],
  },
  {
    slug: "radar",
