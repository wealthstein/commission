...
export const conversions = [
  ...
  },
  {
    ...
    name: "WhatsApp Flow",
    headline: "How a Intent Qualified Lead actually moves through WhatsApp",
    intro:
...
export const features = [
  ...
  },
  {
    ...
    intro:
      "Lead Tracking shows a lead moving through your funnel automatically. Lead Management goes further - filter by status or date, search across everything captured, and export to CSV whenever you need the raw data outside Commission. Available on Medium and Large plans.",
    points: [
      { title: "Filter and search", body: "Narrow leads by status, campaign, or date range instead of scrolling through everything." },
      { title: "Export to CSV", body: "Download your lead data whenever you need it in a spreadsheet, CRM import, or report." },
      { title: "Available on Medium and Large plans", body: "A premium feature - Small plans get full Lead Tracking, without filtering or export." },
    ],
  },
  {
    slug: "team-management",
    name: "Team Management",
    headline: "Invite your team, not just yourself",
    intro:
      "Running campaigns is rarely a one-person job. Invite teammates into your business account and give each one a role that matches what they should actually be able to do - without handing everyone full access.",
    points: [
      { title: "Invite by email", body: "Send an invite, they accept with their own Google sign-in - no shared logins." },
      { title: "Role-based permissions", body: "Owner, Admin, or Member - each with a different level of access to campaigns, leads, and billing." },
      { title: "Available on Medium and Large plans", body: "A premium feature - Small plans are single-user." },
    ],
  },
  {
    slug: "custom-fields",
    name: "Custom Fields",
    headline: "Design your own Long Form questions, per campaign",
    intro:
    ...
    points: [
      ...
      { title: "Medium: up to 5 questions, Large: unlimited", body: "A premium feature - Small plans use the standard Long Form only." },
    ],
  },
];
...
export const integrations = [
  ...
  },
  {
    slug: "api",
    name: "API",
    headline: "Route every Intent Qualified Lead anywhere, automatically",
    intro:
      "With API access, a business can route Intent Qualified Leads to any system they choose - a CRM, a spreadsheet automation, an internal tool, or anywhere else - by pointing Commission at a webhook URL they control. API access is a premium feature on Medium and Large plans.",
    points: [
  ...
  },
  {
    slug: "freshsales",
    name: "Freshsales",
    headline: "Send Intent Qualified Leads into Freshsales via the API",
    intro:
      "Commission does not have a pre-built Freshsales connector - but with API access, every Intent Qualified Lead can be forwarded to a webhook URL you control, which you point at a Freshsales-compatible inbound webhook or automation tool to land leads there directly.",
    points: [
  ...
  },
  {
    slug: "zoho-crm",
    name: "Zoho CRM",
    headline: "Send Intent Qualified Leads into Zoho CRM via the API",
    intro:
      "There is no dedicated Zoho CRM app - with API access, Commission forwards every Intent Qualified Lead to a webhook URL you control, which you can point at Zoho's inbound webhook or an automation tool that feeds Zoho CRM.",
    points: [
  ...
  },
  {
    ...
    intro:
      "Filtering, searching, and exporting your Intent Intent Qualified Leads is not a separate integration to configure - it is a native part of every Medium and Large plan, available in your dashboard the moment you upgrade. No API key, no webhook, no third-party tool to connect.",
    points: [
      { title: "Nothing to set up", body: "Lead management works the moment you are on Medium or Large - there is no connection step." },
      { title: "Filter, search, export", body: "Narrow your Intent Intent Qualified Leads by status, campaign, or date, and export to CSV whenever you need the raw data." },
      { title: "Works alongside API and email", body: "Use native lead management in your dashboard, and still route leads to your own systems via API or email forwarding if you want both." },
    ],
  },
];
