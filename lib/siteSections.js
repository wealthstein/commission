...
export const conversions = [
  {
    ...
    intro:
      "A qualified-lead campaign never charges you for a click or a form submission alone. An affiliate shares a link, the prospect moves through a interest form and a WhatsApp handoff, and only once they complete the full qualification step does anything leave your Campaign Wallet.",
    points: [
  ...
  },
  {
    ...
    intro:
      "A qualified-lead campaign is built around a specific funnel: a Interest Form, a unique WhatsApp handoff, a Intent Form, and then a Thank You page - here is what happens at each step.",
    points: [
...
export const integrations = [
  ...
  },
  {
    slug: "whatsapp",
    name: "WhatsApp",
    headline: "WhatsApp is a native follow-up channel, not a forced step",
    intro:
      "After a lead is captured, WhatsApp is available as a fast, familiar way to follow up - but it is your team's choice, not an automatic redirect. Set your number once and it is ready whenever you want to use it.",
    points: [
      { title: "Native, not bolted on", body: "Your WhatsApp number is attached to your account or a specific campaign, ready the moment you want to use it." },
