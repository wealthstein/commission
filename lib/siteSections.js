...
export const conversions = [
  {
    slug: "intent-qualified-leads",
    name: "Intent Qualified Leads",
    headline: "Pay only when a lead is actually qualified",
    intro:
      "A qualified-lead campaign never charges you for a click or a form submission alone. An affiliate shares a link, the prospect moves through an Interest Form - either Commission's hosted page or your own site - and only once they complete the full qualification step does anything leave your Campaign Wallet.",
    points: [
  ...
  },
  {
    ...
    intro:
      "A direct-sale campaign is for products a customer can pay for immediately. The customer pays on your own website, and Paystack splits that single payment automatically - your proceeds route straight to your own settlement account, and the affiliate commission is paid out from the rest.",
    points: [
  ...
  },
  {
    ...
    intro:
      "A qualified-lead campaign always ends the same way - a completed Intent Form is what charges your Campaign Wallet and pays your affiliates - but it can start on either of two pages, depending on your plan and setup.",
    points: [
      {
        title: "1. Interest Form",
        body: "On Commission's hosted page (every plan), or on your own site via the custom integration (Medium and Large) - either way, the prospect gives their name, phone, and email after clicking an affiliate's link.",
      },
      {
        title: "2. Radar check",
        body: "On the hosted page, trusted affiliates' leads go straight through and unproven affiliates see a quick verification step, right on the same page. On your own site, that capture-time check is skipped, but qualification still runs a real confirmation through an embedded widget, plus invisible signal checks on every submission either way.",
      },
      {
        title: "3. Intent Form and qualification",
        body: "The prospect completes a longer form (or your own site's embedded confirmation, for the custom integration) - this is what actually charges your Campaign Wallet and pays your affiliates.",
      },
    ],
  },
  {
    ...
    points: [
      { title: "Intent Qualified Leads uses a prepaid wallet", body: "The business tops up a Campaign Wallet in advance, and an Intent Qualified Lead deducts from it automatically." },
...
export const locations = [
  {
    ...
    intro:
      "Lagos has Nigeria's densest concentration of both businesses looking to grow and affiliates with real audiences ready to promote them. Commission works the same way everywhere - list a campaign, set what an Intent Qualified Lead or sale is worth, and let affiliates do the rest.",
    points: [
...
export const features = [
  {
    ...
    intro:
      "Every referral link click is recorded and attributed to the affiliate who shared it, through to whether it became an Intent Qualified Lead - all without any manual reconciliation.",
    points: [
...
export const solutions = [
  {
    ...
    points: [
      { title: "Ad spend charges you the moment someone clicks", body: "Whether or not that click ever becomes a real customer." },
  ...
  },
  {
    ...
    intro:
      "A direct-sale campaign on Commission adds a new, pay-for-performance channel on top of your existing sales efforts - customers pay on your own website, split automatically between you and the affiliates who brought the sale.",
    points: [
      { title: "A new sales channel usually means new headcount first", body: "Before it earns a naira back." },
  ...
  },
  {
    ...
    intro:
      "Commission is built around one idea: you only pay when something actually happens - an Intent Qualified Lead or a verified sale - not for impressions, clicks, or reach.",
    points: [
      { title: "Most ad spend is priced on attention, not results", body: "You pay whether or not anyone actually converts." },
  ...
  },
  {
    ...
    points: [
      { title: "Cold advertising reaches strangers", body: "People who have no existing reason to trust what you're selling yet." },
  ...
  },
  {
    ...
    points: [
      { title: "Building a real distribution network usually means hiring first", body: "Recruiting, training, and paying a sales team before you see any results." },
  ...
  },
  {
    ...
    points: [
      { title: "Reaching a new city usually means opening an office there first", body: "Or hiring local staff before you make a single sale in that market." },
...
export const integrations = [
  {
    slug: "custom-lead-automation",
    name: "Lead Automation",
    headline: "Capture leads on your own site instead of Commission's hosted page",
    intro:
      "Available on Medium and Large plans, for lead-goal campaigns - add one script tag to your own site, then call a single function from your form's submit handler, and leads are created directly in Commission with no customer redirect at all. Small plan campaigns aren't left without an option, though - they still work completely normally on Commission's own hosted Interest/Intent Form pages. That isn't a fallback, it's the actual default product, fully branded to your business. Medium and Large simply add the option to keep customers on your own domain instead.",
    industries: ["Real Estate", "Insurance", "Fintech", "HR Software", "SaaS"],
    points: [
      { title: "Your own domain, your own branding", body: "Customers never see commission.ng - the entire experience stays on your site." },
      { title: "One script tag, one function call", body: "No SDK to install, no backend integration - drop in the script and call Commission.trackLead()." },
      {
        title: "Verification still happens, just at a different moment",
        body: "Capture skips Radar's inline check, but qualification still runs a real confirmation through an embedded widget on your own page, plus invisible signal checks on every submission regardless.",
      },
    ],
  },
  {
    ...
    headline: "Customers check out on your own site, never on a Commission-hosted page",
    intro:
      "Required for every sale-goal campaign, on every plan - a real website is what makes a sale-goal campaign feel legitimate to a paying customer. Add the tracking script, then call one function from your own \"Buy\"/\"Subscribe\" button to send the customer straight to Paystack.",
    points: [
      { title: "No plan restriction", body: "Unlike the lead-side integration, every plan gets this - a sale-goal campaign genuinely doesn't work well without it." },
      { title: "Commission is never in the page path", body: "The referral link redirects straight to your own site; checkout initiates from there, not from a commission.ng page." },
      { title: "Same Paystack split underneath", body: "The actual payment split between you and the affiliate works identically to the hosted flow - only where the customer clicks \"Buy\" changed." },
    ],
  },
  {
    slug: "radar",
    name: "Radar",
    headline: "Radar is Commission's built-in trust layer",
    intro:
      "Radar is not a setting to configure - it runs on every lead-goal campaign automatically, on every plan. It works in two layers: a quick confirmation step for leads referred by an affiliate who hasn't yet proven themselves, and a separate set of signals that run silently on every single lead, regardless of trust status.",
    points: [
      ...
      { title: "Invisible to trusted affiliates, and invisible full stop for the second layer", body: "A proven affiliate's leads pass through exactly as fast as before Radar existed. The signal layer never shows the customer anything at all - no code, no extra step." },
  ...
  },
  {
    ...
    intro:
      "Paystack is not an add-on - it is the payment rail underneath the entire platform. Funding your Campaign Wallet, paying out affiliate commissions, and splitting a direct sale between you and your affiliate all run through Paystack automatically, no matter where the checkout itself initiates from.",
    points: [
      ...
      {
        title: "Split checkout for direct sales",
        body: "A sale-goal campaign's checkout initiates from your own site (see Custom integration), not a Commission-hosted page - but the payment itself still splits automatically between you and the affiliate in the same Paystack transaction.",
      },
    ],
  },
  {
    slug: "lead-management",
    name: "Lead Management",
    headline: "Filter and search are built in; export is a Large-plan feature",
    intro:
      "Filtering and searching your leads is a native part of every dashboard, free on every plan - no API key, no third-party tool to connect. Exporting to CSV is a Large-plan feature specifically, not something every plan gets for free.",
    points: [
      { title: "Filter and search, free on every plan", body: "Narrow your leads by status, campaign, or date - works the moment you have a campaign live, no setup." },
      { title: "CSV export - Large plan only", body: "Opens cleanly in Excel or Google Sheets, but this specific action is gated to the Large plan, not included on Small or Medium." },
