 ...
 *   9. Challenges   - real objection-handling content, ties directly to Radar
...
import { conversions, challenges, campaignTypes, features, solutions, integrations } from "@/lib/siteSections";
  ...
  return [
    ...
    },
    {
      ...
      links: [
        ...
        { label: "Pricing", href: urls.audienceHome("business", "pricing") },
    ...
    {
      title: "Challenges",
      indexHref: urls.challengesIndex(),
      links: challenges.map((c) => ({ label: c.name, href: urls.challenge(c.slug) })),
    },
    {
      title: "Conversions",
