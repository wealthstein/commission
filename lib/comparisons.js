...
export const comparisons = [
  {
    ...
    intro:
      "Google Ads charges you for every click, whether or not it turns into anything. Commission only charges when a referral actually turns into an Intent Qualified Lead or a verified sale.",
    points: [
      {
  ...
  },
  {
    ...
    intro:
      "Social ad platforms charge for impressions and clicks regardless of quality. Commission charges only for an Intent Qualified Lead or a verified sale, and Nigerian affiliates already know how to convert their own audience on WhatsApp and social media.",
    points: [
      {
        title: "Outcome-based, not impression-based",
        body: "Meta charges for reach whether or not anyone converts. Commission only debits your wallet on an Intent Qualified Lead or a verified sale.",
      },
      {
  ...
  },
  {
    ...
    points: [
      ...
      },
      {
        ...
        body: "A cold email campaign costs the same whether it converts or not. Commission only charges for an Intent Qualified Lead or a verified sale.",
      },
    ],
  },
  {
    ...
    points: [
      {
        ...
        body: "A flat influencer fee is due whether the post converts or not. Commission only debits your wallet on an Intent Qualified Lead or verified sale.",
      },
      {
  ...
  },
  {
    ...
    intro:
      "TikTok Ads charges for reach and views regardless of whether anyone converts, and creative burns out fast on the platform. Commission only charges for an Intent Qualified Lead or a verified sale, however the affiliate reaches their audience.",
    points: [
      {
