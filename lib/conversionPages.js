...
export const conversionPages = [
  {
    ...
    body: "A lead-goal campaign never charges anything for a click or a form submission alone. A prospect moves through Commission's hosted Short Form and Long Form, checked against the referring affiliate's track record along the way - only once the Long Form is complete and the lead is marked qualified does anything get charged, straight from your Campaign Wallet.",
  ...
  },
  {
    ...
    body: "A sale-goal campaign routes the customer through a Commission-hosted checkout. Paystack splits the payment the moment it happens - your own proceeds land in your connected settlement account, and the affiliate commission is paid out automatically, no manual step required.",
