  ...
  return {
    ...
    html: outreachWrap(
      outreachBadge("Partnership Opportunity") +
        ...
        outreachParagraph(
          `Hi ${firstName}, most ad spend is paid upfront, whether or not it turns into a customer - you're betting on an algorithm, with no guarantee of a real result at the other end.`
        ) +
        outreachCallout(
  ...
  return {
    ...
    html: outreachWrap(
      outreachHeading("I'll leave it here") +
        outreachParagraph(
          `Hi ${firstName}, didn't want to keep following up without a clear signal this is useful. Commission's the short version - list what you're selling, affiliates bring in customers, you only pay for a real result. If that becomes a priority down the line, commission.ng has the details whenever it's relevant.`
        ) +
