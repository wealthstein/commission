        ...
        <table role="presentation" width="100%" style="max-width:480px;" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td style="border-top:1px solid ${BORDER}; padding-top:24px;">
              <p style="margin:0; font-size:11px; color:${MUTED}; text-align:center;">© ${new Date().getFullYear()} Commission &nbsp;•&nbsp; Built with ❤️ in Wilmington, Delaware</p>
            </td>
          </tr>
        </table>
      </td>
  ...
  return {
    ...
    html: wrap(
      heading("A quick question") +
        paragraph(`Hi ${firstName}, curious how you're currently finding new customers beyond word of mouth.`) +
        paragraph(
  ...
  return {
    ...
    html: wrap(
      heading("No fixed ad budget required") +
        paragraph(
          `Hi ${firstName}, if this hasn't been a priority, that's completely fair. Just flagging that Commission's fee only applies to your Campaign Wallet top-up - nothing further is owed unless a lead or sale actually happens.`
        ) +
  ...
  return {
    ...
    html: wrap(
      heading("I'll leave it here") +
        ...
        paragraph("Wishing you well either way.")
    ),
  };
}
