...
function outreachSignature() {
  return `<tr><td style="padding-top:32px; margin-top:8px; border-top:1px solid ${BORDER};"><table role="presentation" cellpadding="0" cellspacing="0"><tr><td style="padding-top:24px; font-size:16px; font-weight:600; color:${INK};">Kemi Banks</td></tr><tr><td style="font-size:14px; color:${MUTED};">Founder, Commission</td></tr></table></td></tr>`;
}
