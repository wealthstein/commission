...
const FROM_NAME = process.env.EMAIL_FROM_NAME || "Bukola Banks";
const FROM_ADDRESS = process.env.EMAIL_FROM_ADDRESS || "nigeria@commission.ng";
...
const OUTREACH_FROM_ADDRESS = process.env.OUTREACH_FROM_ADDRESS || "nigeria@commission.ng";
